...
# DTS2017062912180 chengminhong cwx468106 20170629 end
...
CUSTOM_MODEM = huawei6750_66_n_lwctg_mp3 huawei6750_66_n_c2k
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_VILTE_UI_COMPATIBLE = yes
DCORE_TEST_MODE1 = no
...
MTK_AOD_SUPPORT = no
MTK_API_CHECK = yes
#DTS2017041112918 yangchi/ywx461379 20170411 begin
MTK_BICR_SUPPORT = yes
#DTS2017041112918 yangchi/ywx461379 20170411 end
...
# DTS2017050903128 wangmian wwx446404 20170509 begin
MTK_AUDIO_SPEAKER_PATH = int_hp_buf
# DTS2017050903128 wangmian wwx446404 20170509 end
...
# DTS2017041011977 chaibin cwx464984 20170410 begin
MTK_BQ24157_SUPPORT = no
MTK_FAN54005_SUPPORT = yes
# DTS2017041011977 chaibin cwx464984 20170410 end
...
MTK_BUILD_VERNO = alps-mp-n0.mp7-V2.20_huawei6750.66.ot.n_P85
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 2
...
# DTS2017050406385 fwx461398 fengzhicheng 20170503 begin
MTK_CAM_ZSDHDR_SUPPORT = yes
# DTS2017050406385 fwx461398 fengzhicheng 20170503 end
...
# DTS2017032305324 yuanbin wx218297 20170323 begin
MTK_DRM_APP = no
# DTS2017032305324 yuanbin wx218297 20170323 end
...
#DTS2017031610974 ONTIM<houruiyang><20170313><add back mic test item for CIT> begin
MTK_DUAL_MIC_SUPPORT = yes
#DTS2017031610974 ONTIM<houruiyang><20170313><add back mic test item for CIT> end
...
#/* DTS2017032906538  youhongtao/ywx441815 20170329 begin */
# temporary close
MTK_ENCRYPTION_TYPE_FILE = yes
#/* DTS2017032906538  youhongtao/ywx441815 20170329 end */
...
MTK_ION_SUPPORT = yes
MTK_IPOH_SUPPORT = no
#/* DTS2017032810628 quanjia/qwx441805 20170328 begin */
MTK_IPO_SUPPORT = no
#/* DTS2017032810628 quanjia/qwx441805 20170328 end */
MTK_IPTV_SUPPORT = no
...
MTK_IRTX_SUPPORT = no
# < DTS2017050811702  pugaowei/pwx470671 20170508 begin
MTK_JEITA_STANDARD_SUPPORT = yes
# DTS2017050811702  pugaowei/pwx470671 20170508 end >
...
MTK_NO_TRAN_ANIM = no
# /* < DTS2017042001607 puhao/pwx441847 20170420 begin */
MTK_NTFS_OPENSOURCE_SUPPORT = yes
# /* DTS2017042001607 puhao/pwx441847 20170420 end > */
...
#DTS2017031303054 fengyun fwx443402 20170307 start
MTK_PERSIST_PARTITION_SUPPORT = yes
#DTS2017031303054 fengyun fwx443402 20170307 end
...
# < DTS2017042509506 pugaowei/pwx470671 20170425 begin
MTK_PUMP_EXPRESS_PLUS_SUPPORT = no
# DTS2017042509506 pugaowei/pwx470671 20170425 end >
...
# < DTS2017061514560 wangqiwei/wwx456474 20170619 begin
MTK_SIM_HOT_SWAP = no
MTK_SIM_HOT_SWAP_COMMON_SLOT = no
# DTS2017061514560 wangqiwei/wwx456474 20170619 end >
...
# DTS2017041112704  sunyue swx468104 20170414 begin
ONTIM_APPARATUS_TYPE = yes
# DTS2017041112704  sunyue swx468104 20170414 end

# DTS2017041007024 ywx446407 20170425 begin
BOARD_CHARGER_ENABLE_SUSPEND := true
# DTS2017041007024 ywx446407 20170425 end

# DTS2017050807560 qwx441805 20170508 begin
ONTIM_BUILD = yes
# DTS2017050807560 qwx441805 20170508 end

#CREATE_PROJECT_INFO=2017012418333

# DTS2017042604154 zwx463324 20170520 begin
CUSTOM_VILTE_UI_COMPATIBLE = yes
# DTS2017042604154 zwx463324 20170520 end
